...
function selectAns(choice) {
    ...
    if(correct){
        ...
        heading.innerHTML = "<h2>Correct! <img src='./Assets/right-" + Math.floor(Math.random() * 4 + 1 )+ ".jpg'/></h2>";
        ...
        console.log("score: " + score);
        heading.classList.remove("hide");
        heading.innerHTML = "<h2>Incorrect <img src='./Assets/wrong-" + Math.floor(Math.random() * 4 + 1 )+ ".jpg'/></h2>";
